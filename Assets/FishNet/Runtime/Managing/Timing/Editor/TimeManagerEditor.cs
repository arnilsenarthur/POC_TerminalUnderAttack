...
namespace FishNet.Managing.Timing.Editing
{
    ...
    public class TimeManagerEditor : Editor
    {
        ...
        {
            _updateOrder = serializedObject.FindProperty("updateOrder");
            _timingType = serializedObject.FindProperty("timingType");
            _tickRate = serializedObject.FindProperty("tickRate");
            _allowTickDropping = serializedObject.FindProperty("allowTickDropping");
            _maximumFrameTicks = serializedObject.FindProperty("maximumFrameTicks");
            _pingInterval = serializedObject.FindProperty("pingInterval");
            // _timingInterval = serializedObject.FindProperty("timingInterval");
            _physicsMode = serializedObject.FindProperty("physicsMode");
        }
